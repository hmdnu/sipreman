...
class m_033RegencyChampTrigger extends BaseMigration implements Migration
{
    private string $triggerName = "insert_regency_champ";
    private string $insertedTable = "regency_champ";
    private string $level = "regency";
