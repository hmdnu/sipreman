    ...
    <form action="/post-prestasi" method="post" class="flex-1 ml-64 p-8">
            ...
            <div class="bg-white shadow-md rounded-lg p-6 max-w-md w-full">  
                <div class="flex items-center mb-4">  
                    ...
                    <h3 class="text-xl font-bold text-red-500">Data Gagal Divalidasi</h3>  
                </div>  
                <p class="text-gray-700">  
                    Terdapat beberapa kesalahan. Nomor surat tugas tidak valid. Periksa kembali data informasi administrasi anda.  
                </p>  
            </div>  
