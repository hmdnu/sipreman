...
<div class="flex-1 p-8">  
    <div class="bg-white rounded-lg shadow-md p-6">  
        ...
        <!-- Pagination -->  
        <div class="flex items-center justify-center bg-[var(--Primary-pr00,#F9F6FD)] w-[225px] h-[51px] rounded-[5px] shrink-0">  
            <div class="flex items-center justify-center w-full">  
                <nav class="isolate inline-flex -space-x-px" aria-label="Pagination">  
                    <!-- Previous Button -->  
                    <a href="#" class="relative inline-flex items-center rounded-l-md px-3 py-2 text-gray-400 hover:bg-[#6F38C5] focus:z-20">  
                        <span class="sr-only">Previous</span>  
                        &lt;  
                    </a>  
                    <!-- Page Numbers -->  
                    <a href="#" aria-current="page" class="relative z-10 inline-flex items-center bg-[#6F38C5] px-3 py-2 text-sm font-semibold text-white focus:z-20">1</a>  
                    <a href="#" class="relative inline-flex items-center px-3 py-2 text-sm font-semibold text-gray-900 hover:bg-[#6F38C5] focus:z-20">2</a>  
                    <span class="relative inline-flex items-center px-3 py-2 text-sm font-semibold text-gray-700">...</span>  
                    <a href="#" class="relative inline-flex items-center px-3 py-2 text-sm font-semibold text-gray-900 hover:bg-[#6F38C5] focus:z-20">12</a>  
                    <!-- Next Button -->  
                    <a href="#" class="relative inline-flex items-center rounded-r-md px-3 py-2 text-gray-400 hover:bg-[#6F38C5] focus:z-20">  
            ...
            <table class="min-w-full bg-white">  
                ...
                <tbody class="text-[12px]">  
                    <tr class="border-b">  
                        ...
                        <td class="px-4 py-2">Kompetisi Cyber Jawara Nasional 2023</td>  
                        <td class="px-4 py-2">ST1/Jawara/2023/001</td>  
                        <td class="px-4 py-2 text-center">Nasional</td>  
                        <td class="px-4 py-2 text-center">Ketua</td>  
                        <td class="px-4 py-2 text-center">6.5</td>  
                        <td class="px-4 py-2">  
                    ...
                    <tr class="border-b">  
                        ...
                        <td class="px-4 py-2">Kompetisi Cyber Jawara Nasional 2023</td>  
                        <td class="px-4 py-2">ST1/Jawara/2023/002</td>  
                        <td class="px-4 py-2 text-center">Nasional</td>  
                        <td class="px-4 py-2 text-center">Anggota</td>   
