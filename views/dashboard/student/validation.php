            ...
            <table class="min-w-full bg-white">
                ...
                for ($i = 0; $i < count($prestasiData); $i++) {
                    echo "<tr class='border-b'>
                            ...
                            <td class='px-4 py-2'>";
                    if ($prestasiData[$i]["validation_state"] === ValidationState::VALID) {
                    ...
                    } else if ($prestasiData[$i]["validation_state"] === ValidationState::WAITING) {
                        echo "<div class='flex items-center justify-center gap-2'>                                 
                                <button class='p-1.5 bg-orange-100 text-orange-800 rounded-lg hover:bg-orange-200' title='Menunggu Validasi' disabled>
                                    <img src='/public/assets/icon/waiting_validation.png' alt='Waiting' class='h-5 w-5'>
                                </button>
                                <button class='p-1.5 bg-gray-100 text-gray-300 rounded-lg cursor-not-allowed' title='Tidak dapat diedit' disabled>
                                    <img src='/public/assets/icon/edit_icon.png' alt='Edit' class='h-5 w-5'>
                                </button>
