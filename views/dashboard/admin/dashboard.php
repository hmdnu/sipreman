    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-7">
            ...
            <div class="p-6 bg-[#083DED] text-white rounded-lg shadow-md w-[250px] h-[200px]">
                ...
                <p class="text-4xl font-bold"><?= View::getData()["stats"]["international"]["total_victors"] ?></p>
            </div>
            ...
            <div class="p-6 bg-[#49B195] text-white rounded-lg shadow-md w-[250px] h-[200px]">
                ...
                <p class="text-4xl font-bold"><?= View::getData()["stats"]["national"]["total_victors"] ?></p>
            </div>
            ...
            <div class="p-6 bg-[#F65C5C] text-white rounded-lg shadow-md w-[250px] h-[200px]">
                ...
                <p class="text-4xl font-bold"><?= View::getData()["stats"]["province"]["total_victors"] ?></p>
            </div>
            ...
            <div class="p-6 bg-[#626262] text-white rounded-lg shadow-md w-[250px] h-[200px]">
                ...
                <p class="text-4xl font-bold"><?= View::getData()["stats"]["regency"]["total_victors"] ?></p>
            </div>
