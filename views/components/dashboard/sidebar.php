...
<aside class="w-64 bg-[#F9F6FD] shadow-2xl p-6 h-screen fixed flex flex-col justify-between">
    <section>
        ...
        <div class="text-center mb-6">
            ...
            <h2 class="text-[20px] font-semibold"><?php echo View::getData()["studentData"]["name"] ?>
            </h2>
            <p class="text-[12px] font-medium text-gray-500"><?php echo View::getData()["studentData"]["nim"] ?></p>
        </div>
