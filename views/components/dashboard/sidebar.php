...
<aside class="w-64 bg-[#F9F6FD] shadow-2xl p-6">
    <!-- Logo -->
    ...
    <!-- user profile -->
    <div class="text-center mb-6">
        <img src="https://via.placeholder.com/100" alt="profile picture" class="w-20 h-20 rounded-full mx-auto mb-2" />
        <h2 class="text-[20px] font-semibold"><?php echo View::getProps()["name"] ?? "" ?></h2>
        <p class="text-[12px] font-medium text-gray-500"><?php echo View::getProps()["nim"] ?></p>
    </div>

    <!-- side bar -->
    <div class="space-y-4">
        <!-- upload -->
        <a href="/dashboard/student/<?php echo Session::get("user") ?>"
        ...
        <!-- validation -->
        <a href="/dashboard/student/<?php echo Session::get("user") ?>/validation"
        ...
        <!-- my points -->
        <a href="/dashboard/student/<?php echo Session::get("user") ?>/point"
            class="text-[12px] font-medium w-full flex items-center gap-2 py-2 px-4 bg-white text-gray-700 border border-gray-300 rounded-lg shadow hover:bg-[#6F38C5] hover:text-white active:bg-[#6F38C5] active:text-white transition duration-300">
    ...
    <div class="sticky bottom-0 mt-4">
        <button class="text-[12px] font-medium w-full flex items-center justify-center py-2 px-4 bg-gray-300
