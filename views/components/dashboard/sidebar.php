...
<aside class="w-64 bg-[#F9F6FD] shadow-2xl p-6 h-screen fixed flex flex-col justify-between">
    <section>
        ...
        <!-- user profile -->
        <div class="text-center mb-6">
            <img src="/public/assets/img/user.png" alt="profile picture" class="w-20 h-20 rounded-full mx-auto mb-2" />
        ...
        <div class="space-y-4 py-4">
            <div class="space-y-4 py-4">
                ...
                <a href="/dashboard/student/<?php echo View::getData()["studentData"]["nim"] ?>"
                    ...
                    <img src="<?php echo strpos($currentUrl, '/dashboard/student/' . View::getData()["studentData"]["nim"]) !== false && strpos($currentUrl, '/validation') === false && strpos($currentUrl, '/point') === false ? '/public/assets/icon/unggah_white.png' : '/public/assets/icon/upload_icon.png'; ?>"
                        alt="Icon Upload" class="h-4 w-4" />
                    Unggah Prestasi
                </a>
                ...
                <a href="/dashboard/student/<?php echo View::getData()["studentData"]["nim"] ?>/validation"
                    ...
                    <img src="<?php echo strpos($currentUrl, '/validation') !== false ? '/public/assets/icon/validation_white.png' : '/public/assets/icon/validation_icon.png'; ?>"
                        alt="icon validation" class="h-4 w-4" />
                    Cek Validasi
                </a>
                ...
                <a href="/dashboard/student/<?php echo View::getData()["studentData"]["nim"] ?>/point"
                    ...
                    <img src="<?php echo strpos($currentUrl, '/point') !== false ? '/public/assets/icon/poinku_white.png' : '/public/assets/icon/point_icon.png'; ?>"
                        alt="icon poin" class="h-4 w-4" />
                    Poinku
                </a>
            </div>
    </section>
