    ...
    <div class="absolute inset-0 flex items-center justify-center z-5">
        <div class="container mx-auto text-center text-neutral-0 px-4">
            <h1 class="h1 font-bold max-w-[705px] mx-auto text-center">
                <span class="text-secondary-600">Kelola Prestasimu</span> dan <span class="text-secondary-600">konversi</span> jadi poin SKKM dengan mudah!
            </h1>

            <p class="h5 font-medium max-w-[625px] mx-auto text-center py-10">
                Platform terpadu untuk pengelolaan prestasi, konversi menjadi poin SKKM, dan pantau statistik jurusan di Politeknik Negeri Malang
            </p>
        </div>
    </div>
    </div>
        ...
        <div class="custom-container">
            <div class="flex justify-center items-center">
                ...
                <div class="flex flex-col items-center py-20 mr-20 ml-10">
                    <img src="/public/assets/icon/upload_achievement.png" alt="Unggah Prestasi" class="w-[75px] h-[75px] mb-3">
